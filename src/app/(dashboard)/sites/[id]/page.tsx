...
import { useSite, useDeleteSite } from "@/features/sites/hooks";
...
import { SiteActivityTab, SiteDocumentsTab, SiteOverviewTab, SiteTeamTab, SiteUnitsTab } from "@/features/sites/components";
...
export default function SiteDetailsPage() {
    ...
    const handleDelete = async () => {
        try {
            ...
            // La mutation redirige automatiquement vers /sites
        } catch (error) {
    ...
    return (
        ...
        <>
            ...
            <div className="flex flex-col overflow-hidden bg-gradient-to-br from-background via-background to-muted/20">
                {/* Hero Header - même code qu'avant... */}
            ...
            < AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog} >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Cette action est irréversible. Le site "{site.name}" et toutes ses données associées seront supprimés définitivement.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
