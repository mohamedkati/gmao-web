...
import { CustomerListItem, CustomerFormData, CustomerContact, MaintenanceBudget, Customer } from '../../customers-v2/types/customer.types';
import { ApiResponse, ApiValidationResponse, PaginatedResponse } from '@/shared/types/common.types';
...
export const customerService = {
  ...
  getAll: async (params?: any) => {
    ...
    // Ajouter tous les params non-null
    ...
    const response: PaginatedResponse<CustomerListItem[]> = await apiClient.get(`${BASE_URL}?${queryString.toString()}`);
    return response;
  },
