...
import { usePropertyGroupStatistics } from "../hooks/index";
import { formatCurrency } from "../utils/property-groups.utils";
import { Skeleton } from "@/shared/components/shadcnui/skeleton";

export function PropertyGroupStatsCards() {
  const { data: stats, isLoading } = usePropertyGroupStatistics();
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            {stats.activeGroups} actifs, {stats.prospectGroups} prospects
          </p>
        </CardContent>
      </Card>
